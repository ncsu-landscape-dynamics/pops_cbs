...
load(paste0(cbs_out, "calibration_outputs_2013.rdata"))
...
cal_2014 <- PoPS::calibrate(
  ...
  prior_number_of_observations = 188,
  prior_means,
  prior_cov_matrix,
...
file_name <- paste(cbs_out, "calibration_outputs_2014.rdata", sep = "")
save(cal_2014, file = file_name)