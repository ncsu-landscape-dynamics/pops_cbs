...
load(paste0(cbs_out, "calibration_outputs_2014.rdata"))
prior_means <- cal_2014$posterior_means
prior_cov_matrix <- cal_2014$posterior_cov_matrix
...
cal_2015 <- PoPS::calibrate(
  ...
  prior_number_of_observations = 221,
  prior_means,
  prior_cov_matrix,
...
file_name <- paste(cbs_out, "calibration_outputs_2015.rdata", sep = "")
save(cal_2015, file = file_name)