...
load(paste0(cbs_out, "calibration_outputs_2015.rdata"))
prior_means <- cal_2015$posterior_means
prior_cov_matrix <- cal_2015$posterior_cov_matrix
...
cal_2016 <- PoPS::calibrate(
  ...
  prior_number_of_observations = 246,
...
file_name <- paste(cbs_out, "calibration_outputs_2016.rdata", sep = "")
save(cal_2016, file = file_name)
