...
prior_means <- read.csv(paste0(cbs_out, "posterior_means_2016.csv"))
prior_means <- prior_means$x
prior_means <- prior_means[1:6]

# posterior covariance matrix from previous calibration
prior_cov_matrix <- read.csv(paste0(cbs_out, "posterior_cov_matrix_2016.csv"))
