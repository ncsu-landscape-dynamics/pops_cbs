...
load(paste0(cbs_out, "calibration_outputs_2017.rdata"))
prior_means <- cal_2017$posterior_means
prior_cov_matrix <- cal_2017$posterior_cov_matrix
...
cal_2018 <- PoPS::calibrate(
  ...
  infected_file_list = paste0(cbs_path, "infection/cbs_2018.tif"),
...
file_name <- paste(cbs_out, "calibration_outputs_2018.rdata", sep = "")
save(cal_2018, file = file_name)
