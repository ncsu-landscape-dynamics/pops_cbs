...
load(paste0(cbs_out, "calibration_outputs_2018.rdata"))
prior_means <- cal_2018$posterior_means
prior_cov_matrix <- cal_2018$posterior_cov_matrix
...
cal_2019 <- PoPS::calibrate(
  ...
  prior_number_of_observations = 304,
...
file_name <- paste(cbs_out, "calibration_outputs_2019.rdata", sep = "")
save(cal_2019, file = file_name)
