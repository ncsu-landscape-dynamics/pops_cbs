...
cal_2019 <- PoPS::calibrate(
  ...
  infected_file_list = paste0(cbs_path, "infection/cbs_2019.tif"),
...
file_name <- paste0(cbs_out, "posterior_means_2019.csv")
write.csv(cal_2019$posterior_means, file_name, row.names = FALSE)

file_name <- paste0(cbs_out, "posterior_cov_matrix_2019.csv")
