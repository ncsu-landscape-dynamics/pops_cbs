...
PoPS::calibrate(
  infected_years_file = rast(paste0(paste0(cbs_path, "infection/"), list.files(paste0(cbs_path, "infection/"), pattern = "*.tiff"))[-c(4)]),
  ...
  infected_file_list = paste0(cbs_path, "infection/cbs_2013.tiff"),
